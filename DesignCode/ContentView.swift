...
//  DesignCode
//
//  Created by James Talano on 9/15/20.
...
struct CardBottomView: View {
   var body: some View {
      return VStack(spacing: 20.0) {
         ...
         Text("This certificate is proof that James Talano has achieved UI Design course with approval from a Design+Code instructor.")
            .lineLimit(nil)
